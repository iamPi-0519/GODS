"""
This is the legacy template for implementing `alfworld.py`. It contains an example of a working Rollout Function implementation for the Alfworld Environment Task.
