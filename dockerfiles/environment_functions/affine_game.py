        ...
        while not done and (turn_number < current_max_turn):
            ...
            if turn_number == 0:
                ...
                if prev_full_ids is None:
                    ...
                    # Number of different tokens between prev_full_ids and prompt_ids
                    num_different_tokens = len(set(prev_full_ids) ^ set(prompt_ids))
                    print(f"Number of different tokens: {num_different_tokens}")
